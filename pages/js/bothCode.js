 ...
 * @create date 2021-06-29 10:56:31
 * @modify date 2021-06-29 10:56:31
...
const temp = `
    <div class="flex flex-wrap mt-5 mb-10">
        <div class="w-3/12 bg-gray-200 px-8 pt-8 pb-32 h-screen overflow-y-auto">
            <button class="my-1 p-2 rounded-lg text-sm text-white bg-blue-800" v-on:click="save('bothCode', $refs)">Simpan</button>
